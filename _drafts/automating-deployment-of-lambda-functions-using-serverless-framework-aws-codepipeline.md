...
Once deployed, the output will print the newly created API gateway endpoint. test the function by calling the API endpoint. Something like this,
    ...
    endpoints:
      ...
      GET - \[[https://xxxxx.execute-api.us-east-1.amazonaws.com/dev](https://xxxxx.execute-api.us-east-1.amazonaws.com/dev "https://xxxxx.execute-api.us-east-1.amazonaws.com/dev")\]([https://xxxxx.execute-api.us-east-1.amazonaws.com/dev](https://xxxxx.execute-api.us-east-1.amazonaws.com/dev "https://xxxxx.execute-api.us-east-1.amazonaws.com/dev") "[https://xxxxx.execute-api.us-east-1.amazonaws.com/dev](https://xxxxx.execute-api.us-east-1.amazonaws.com/dev "https://xxxxx.execute-api.us-east-1.amazonaws.com/dev")")
...
test the function by calling the API endpoint.
    ...
    curl \[[https://xxxxx.execute-api.us-east-1.amazonaws.com/dev](https://xxxxx.execute-api.us-east-1.amazonaws.com/dev "https://xxxxx.execute-api.us-east-1.amazonaws.com/dev")\]([https://xxxxx.execute-api.us-east-1.amazonaws.com/dev](https://xxxxx.execute-api.us-east-1.amazonaws.com/dev "https://xxxxx.execute-api.us-east-1.amazonaws.com/dev") "[https://xxxxx.execute-api.us-east-1.amazonaws.com/dev](https://xxxxx.execute-api.us-east-1.amazonaws.com/dev "https://xxxxx.execute-api.us-east-1.amazonaws.com/dev")")
...
\[[https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json](https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json "https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json")\]([https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json](https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json "https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json") "[https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json](https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json "https://github.com/imewish/serverless-nodejs-api/blob/master/codebuild-IAM-policy.json")")
...
You can find it here. \[[https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml](https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml "https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml")\]([https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml](https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml "https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml") "[https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml](https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml "https://github.com/imewish/serverless-nodejs-api/blob/master/buildspec.yml")")
