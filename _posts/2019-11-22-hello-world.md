...
\***Now lets automate the deployment process with Github, AWS Codepipeline__*
...
\*Click on the **Create Project** button, it will take you to* _Codebuild setup page._
...
\*_This role must have enough permissions for serverless framework to deploy the function and its resources to AWS as follows,_*
...
\***After you finish creating the codebuild project go to its IAM role and append the policy with the rules created by the above template.__*
...
Thats it!. Now you can test this by going to the newly created pipeline and click on **_Release Change_**
